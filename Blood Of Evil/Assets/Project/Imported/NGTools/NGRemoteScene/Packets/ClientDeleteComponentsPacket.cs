...
namespace NGTools
{
	[PacketLinkTo(PacketId.Scene_ClientDeleteComponents)]
	public class ClientDeleteComponentsPacket : Packet
	{
		...
		protected	ClientDeleteComponentsPacket(ByteBuffer buffer) : base(buffer)
		{
		}
