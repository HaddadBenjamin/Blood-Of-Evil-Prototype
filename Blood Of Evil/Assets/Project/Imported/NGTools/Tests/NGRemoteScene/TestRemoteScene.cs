	...
	public class TestRemoteScene : MonoBehaviour
	{
		...
		protected virtual void	OnGUI()
		{
			...
			this.scrollPosition = GUI.BeginScrollView(this.r, this.scrollPosition, this.viewRect);
			{
				...
				GUI.Label(r, "3. Open a <b>NG Hierarchy</b> window. You will find it in the menu at <b>Window/NG Hierarchy</b>.", this.labelStyle);
				r.y += r.height + TestRemoteScene.Spacing;

				GUI.Label(r, "4. In <b>NG Hierarchy</b>, type \"<i>127.0.0.1</i>\" in <b>Address</b> and \"<i>17256</i>\" in <b>Port</b>. Now press the button \"<b>Connect</b>\".", this.labelStyle);
				r.y += r.height;
				GUI.Label(r, "   You should see the same Game Object as those in this current scene.", this.labelStyle);
				r.y += r.height + TestRemoteScene.Spacing;

				GUI.Label(r, "5. Open a <b>NG Inspector</b> window. You will find it in the menu at <b>Window/NG Inspector</b>.", this.labelStyle);
				r.y += r.height;
				GUI.Label(r, "   This is the equivalent of Unity's <b>Inspector</b> window", this.labelStyle);
				r.y += r.height + TestRemoteScene.Spacing;

				GUI.Label(r, "6. Open a <b>NG Project</b> window. You will find it in the menu at <b>Window/NG Project</b>.", this.labelStyle);
				r.y += r.height;
				GUI.Label(r, "   This is the equivalent of Unity's <b>Project</b> window", this.labelStyle);
				r.y += r.height + TestRemoteScene.Spacing;

				GUI.Label(r, "7. To choose which assets appear in <b>NG Project</b>, you need to check the assets in <b>Embedded Resources</b> in the component <b>NG Server Scene</b>.", this.labelStyle);
				r.y += r.height;
