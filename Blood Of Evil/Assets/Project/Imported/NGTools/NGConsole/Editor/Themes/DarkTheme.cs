...
namespace NGToolsEditor
{
	public class DarkTheme : Theme
	{
		...
		{
			Color	defaultNormalColor = new Color(180F / 255F, 180F / 255F, 180F / 255F, 1F);
			...
			instance.log.selectedBackground = new Color(.2421875F, .37109375F, .5859375F, 1F);
			instance.log.evenBackground = new Color(.21484375F, .21484375F, .21484375F, 1F);
			instance.log.oddBackground = new Color(.234375F, .234375F, .234375F, 1F);
			...
			instance.log.timeStyle.normal.textColor = new Color(58F / 255F, 206F / 255F, 255F / 255F, 1F);
			...
			instance.stackTrace.returnValueColor = new Color(92F / 255F, 193F / 255F, 114F / 255F, 1F);
			instance.stackTrace.reflectedTypeColor = new Color(141F / 255F, 141F / 255F, 141F / 255F, 1F);
			instance.stackTrace.methodNameColor = new Color(171F / 255F, 171F / 255F, 171F / 255F, 1F);
			instance.stackTrace.argumentTypeColor = new Color(92F / 255F, 193F / 255, 114F / 255F, 1F);
			instance.stackTrace.argumentNameColor = new Color(4F / 255F, 255F / 255F, 224F / 255F, 1F);
			instance.stackTrace.filepathColor = new Color(167F / 255F, 172F / 255F, 172F / 255F, 1F);
			instance.stackTrace.lineColor = new Color(141F / 255F, 141F / 255F, 255F / 255F, 1F);

			instance.stackTrace.previewTextColor = new Color(167F / 255F, 172F / 255F, 172F / 255F, 1F);
			instance.stackTrace.previewLineColor = new Color(141F / 255F, 141F / 255F, 255F / 255F, 1F);

			instance.stackTrace.previewSourceCodeBackgroundColor = new Color(.11484375F, .11484375F, .11484375F, 1F);
			instance.stackTrace.previewSourceCodeMainLineBackgroundColor = new Color(.01484375F, 0.01484375F, .01484375F, 1F);
			...
			if (instance.stackTrace.keywords.Length >= 3)
			{
				...
				{
					instance.stackTrace.keywords[0].color = new Color(4F / 255F, 255F / 255F, 224F / 255F, 1F);
				}
				if (instance.stackTrace.keywords[1].keywords.Length > 0 &&
					instance.stackTrace.keywords[1].keywords[0] == "this")
				{
					instance.stackTrace.keywords[1].color = new Color(92F / 255F, 193F / 255, 114F / 255F, 1F);
				}
				if (instance.stackTrace.keywords[2].keywords.Length > 0 &&
					instance.stackTrace.keywords[2].keywords[0] == "var")
				{
					instance.stackTrace.keywords[2].color = new Color(52F / 255F, 193F / 255, 94F / 255F, 1F);
				}
			}
