...
namespace BloodOfEvil.Scene.Services.Events
{
    ...
    /// <summary>
    /// Permet de s'abonner à des delegate ayant pour prototype : delegate void function(firstParameter, secondParameter, thirdParameter).
    /// </summary>
    /// <typeparam name="EnumerationType"></typeparam>
    public sealed class EventManagerThreeParameters<EnumerationType, FirstParameterType, SecondParameterType, ThirdParameterType> where EnumerationType : struct, IConvertible
    {
        public delegate void Delegate(FirstParameterType firstParameter, SecondParameterType secondParameter, ThirdParameterType thirdParameter);
        ...
        #region Constructor
        public EventManagerThreeParameters()
        {
        ...
        /// </summary>
        /// <param name="enumeration"></param>
        public void CallEvent(EnumerationType enumeration, FirstParameterType firstParameter, SecondParameterType secondParameter, ThirdParameterType thirdParameter)
        {
