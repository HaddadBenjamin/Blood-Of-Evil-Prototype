...
namespace BloodOfEvil.Scene.Services.Events
{
    ...
    /// <summary>
    /// Permet de s'abonner à des delegate ayant pour prototype : delegate void function(firstParameter, secondParameter).
    /// </summary>
    /// <typeparam name="EnumerationType"></typeparam>
    public sealed class EventManagerTwoParameters<EnumerationType, FirstParametersType, SecondParametersType> where EnumerationType : struct, IConvertible
    {
        public delegate void Delegate(FirstParametersType firstParameter, SecondParametersType secondParameter);
        ...
        #region Constructor
        public EventManagerTwoParameters()
        {
        ...
        /// </summary>
        /// <param name="enumeration"></param>
        public void CallEvent(EnumerationType enumeration, FirstParametersType firstParameter, SecondParametersType secondParameter)
        {
