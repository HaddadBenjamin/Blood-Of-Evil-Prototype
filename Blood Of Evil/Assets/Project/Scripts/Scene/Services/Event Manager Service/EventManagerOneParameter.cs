...
namespace BloodOfEvil.Scene.Services.Events
{
    ...
    /// <summary>
    /// Permet de s'abonner à des delegate ayant pour prototype : delegate void function(firstParameter).
    /// </summary>
    /// <typeparam name="EnumerationType"></typeparam>
    public sealed class EventManagerOneParameter<EnumerationType, FirstParameterType> where EnumerationType : struct, IConvertible
    {
        public delegate void Delegate(FirstParameterType paramA);
        ...
        #region Constructor
        public EventManagerOneParameter()
        {
        ...
        /// </summary>
        /// <param name="enumeration"></param>
        public void CallEvent(EnumerationType enumeration, FirstParameterType firstParam)
        {
